...
class SafeVerity extends StatefulWidget {
  ...
  SafeVerity(this.randomX1, this.randomY1, this.randomX2, this.randomY2, {required this.lister});
...
class _SafeVerityState extends State<SafeVerity> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      /// 拖动控制点
      final x1 = radius + widget.randomX1;
      final y1 = radius + widget.randomY1;

      /// 正确答案在下半部分区域
      final x2 = radius + widget.randomX2;
      final y2 = size.height * 0.7 + widget.randomY2 - radius * 1.2 - MediaQuery.of(context).padding.bottom;
          ...
          AnimatedBuilder(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Image.asset('assets/icons/safe_icon.jpg'),
              ),
            ),
          ),
        ],
