...
class RecommendTaskPage extends StatefulWidget {

  List<dynamic> profitProductList = [];

  RecommendTaskPage(this.profitProductList);

  @override
  State<StatefulWidget> createState() => RecommendTaskPageState();
}

class RecommendTaskPageState extends BaseKeepAliveState<RecommendTaskPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0.w,
        centerTitle: true,
        title: Text(LanguageConfig.get(LanguageConfigKeys.Shop_pocket_mxget_task),
