...
class CountUpView extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _CountUpViewState();
  }
}

class _CountUpViewState extends State<CountUpView> {
  // 用来在布局中显示相应的剩余时间
  String remainTime = '';
  Timer? _timer;
  int diffTime = 0;
  ...
  @override
  void didUpdateWidget(CountUpView oldWidget) {
