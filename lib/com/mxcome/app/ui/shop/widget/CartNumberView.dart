...
class CartNumberView extends StatefulWidget {
  ...
  const CartNumberView(this._number, this.onNumberChange, {this.limitNum = 0});
...
class _CartNumberViewState extends BaseKeepAliveState<CartNumberView> {
        ...
        children: <Widget>[
          ...
          InkWell(
            ...
            child: Container(
              ...
              height: double.infinity,
              width: 60.w,
              child: Text('${widget._number}', style: TextStyle(fontSize: 20.sp, color: IConstant.text_color),),
            ),
          ),
          InkWell(
              onTap: () => _add(),
