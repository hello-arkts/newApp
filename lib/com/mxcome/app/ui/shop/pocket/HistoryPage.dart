...
import 'package:mxcome/com/mxcome/app/ui/shop/pocket/HistoryActivityPage.dart';

import '../../../BaseKeepAliveState.dart';
import '../../../config/LanguageConfig.dart';
import 'HistoryTaskPage.dart';
...
class HistoryPageState extends BaseKeepAliveState<HistoryPage>
  ...
  final pages = [HistoryTaskPage(), HistoryActivityPage()];
  ...
  AppBar buildAppBar() {
    return AppBar(
      ...
      titleSpacing: 10.w,
      centerTitle: true,
      title: Text(LanguageConfig.get(LanguageConfigKeys.Shop_pocket_mxget_history),
