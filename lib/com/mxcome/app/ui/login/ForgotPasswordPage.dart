...
class ForgotPasswordPage extends StatefulWidget {
  ...
  ForgotPasswordPage(this.mobile, this.countryCodeModel);

  @override
  State<StatefulWidget> createState() => ForgotPasswordPageState();
}

class ForgotPasswordPageState extends BaseKeepAliveState<ForgotPasswordPage> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      currentCodeModel = widget.countryCodeModel;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return KeyboardDismissOnTap(child: Scaffold(
      ...
      appBar: AppBar(
          elevation: 0.w,
          centerTitle: true,
          title: Text(LanguageConfig.get(LanguageConfigKeys.Login_forgot_password),
            ...
            child: Row(
              children: [
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    Expanded(child: Text(LanguageConfig.get(LanguageConfigKeys.Login_forgot_password_tip1), style: TextStyle(fontSize: 11.sp, color: IConstant.sub_text_color))),
                    Expanded(child: Text(LanguageConfig.get(LanguageConfigKeys.Login_forgot_password_tip2), style: TextStyle(fontSize: 11.sp, color: IConstant.sub_text_color))),
                    Expanded(child: Text(LanguageConfig.get(LanguageConfigKeys.Login_forgot_password_tip3), style: TextStyle(fontSize: 11.sp, color: IConstant.sub_text_color))),
                  ],
                ))
              ],
            ),
